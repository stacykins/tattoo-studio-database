...
## 2. Діаграма ER
![ER-діаграма тату-студії](./erd.drawio.png)
...
## Висновок
У ході виконання лабораторної роботи №1 було проведено аналіз предметної області тату-студії та сформовано документ із функціональними вимогами. 

На основі зібраних вимог:
1. Визначено 6 ключових сутностей (Клієнти, Майстри, Сеанси, Деталі тату, Склад, Витрати).
2. Спроектовано ER-діаграму, яка відображає логічні зв’язки між об’єктами (1:N, 1:1, M:N).
3. Враховано бізнес-правила студії (віковий контроль, фіксація цін, облік матеріалів).
